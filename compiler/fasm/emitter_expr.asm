...
.add_checked:
    ...
    jmp .normalize_result
.uadd_checked:
    call emit_unsigned_add_overflow_check
    test rax, rax
    jnz .fail
    jmp .normalize_result
.sub:
...
.sub_checked:
    ...
    jmp .normalize_result
.usub_checked:
    call emit_unsigned_sub_overflow_check
    test rax, rax
    jnz .fail
    jmp .normalize_result
.mul:
...
.mul_checked:
    ...
    jmp .normalize_result
.umul_checked:
    call emit_unsigned_mul_overflow_check
    test rax, rax
    jnz .fail
    jmp .normalize_result
.div:
...
.rol8:
    mov rsi, asm_rol_al
    mov rdx, asm_rol_al_len
    jmp .emit_rotate
.rol16:
    mov rsi, asm_rol_ax
    mov rdx, asm_rol_ax_len
    jmp .emit_rotate
.rol32:
    mov rsi, asm_rol_eax
    mov rdx, asm_rol_eax_len
    jmp .emit_rotate
.ror:
    mov rdi, r12
    call semantic_expr_type
...
.ror8:
    mov rsi, asm_ror_al
    mov rdx, asm_ror_al_len
    jmp .emit_rotate
.ror16:
    mov rsi, asm_ror_ax
    mov rdx, asm_ror_ax_len
    jmp .emit_rotate
.ror32:
    mov rsi, asm_ror_eax
    mov rdx, asm_ror_eax_len
.emit_rotate:
    mov rdi, [out_fd]
    call write_all
    jmp .normalize_result
...
.pow_unsigned_checked:
    ...
    inc qword [label_counter]
    mov rdi, [out_fd]
    mov rsi, asm_upow_init_pre
    mov rdx, asm_upow_init_pre_len
    call write_all
    mov rax, r15
    mov rdi, [out_fd]
    call write_u64_fd
    ...
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_upow_loop_body_checked_pre
    mov rdx, asm_upow_loop_body_checked_pre_len
    call write_all
    mov rax, r13
    mov rdi, [out_fd]
    call write_u64_fd
    ...
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_upow_overflow_trap
    mov rdx, asm_upow_overflow_trap_len
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_label_pre
    mov rdx, asm_label_pre_len
...
emit_unsigned_add_overflow_check:
    push rbx
    mov rbx, [label_counter]
    inc qword [label_counter]
    mov rdi, [out_fd]
    mov rsi, asm_uadd_overflow_check_pre
    mov rdx, asm_uadd_overflow_check_pre_len
    call write_all
    mov rax, rbx
    mov rdi, [out_fd]
    call write_u64_fd
    ...
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_uadd_overflow_trap
    mov rdx, asm_uadd_overflow_trap_len
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_label_pre
    mov rdx, asm_label_pre_len
...
emit_unsigned_sub_overflow_check:
    push rbx
    mov rbx, [label_counter]
    inc qword [label_counter]
    mov rdi, [out_fd]
    mov rsi, asm_usub_overflow_check_pre
    mov rdx, asm_usub_overflow_check_pre_len
    call write_all
    mov rax, rbx
    mov rdi, [out_fd]
    call write_u64_fd
    ...
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_usub_overflow_trap
    mov rdx, asm_usub_overflow_trap_len
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_label_pre
    mov rdx, asm_label_pre_len
...
emit_unsigned_mul_overflow_check:
    push rbx
    mov rbx, [label_counter]
    inc qword [label_counter]
    mov rdi, [out_fd]
    mov rsi, asm_umul_overflow_check_pre
    mov rdx, asm_umul_overflow_check_pre_len
    call write_all
    mov rax, rbx
    mov rdi, [out_fd]
    call write_u64_fd
    ...
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_umul_overflow_trap
    mov rdx, asm_umul_overflow_trap_len
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_label_pre
    mov rdx, asm_label_pre_len
...
; Modifies: rax, rbx, rcx, rdx, r8, r9
...
.fold_pow:
    ...
    mov rcx, r9
    test r11, r11
    jnz .fold_pow_unsigned_start
    cmp rcx, 0
    jle .folded_ok
    jmp .fold_pow_loop
.fold_pow_unsigned_start:
    test rcx, rcx
    jz .folded_ok
    test r8, r8
    jnz .fold_pow_unsigned_nonzero_base
    xor rax, rax
    jmp .folded_ok
.fold_pow_unsigned_nonzero_base:
    cmp r8, 1
    je .folded_ok
.fold_pow_loop:
    test r11, r11
...
emit_builtin_math_call_expr:
    ...
    call token_text_eq
    test rax, rax
    jnz .popcount_builtin
    mov rdi, r14
    mov rsi, text_leading_zeros
    mov rdx, 13
    call token_text_eq
    test rax, rax
    jnz .leading_zeros_builtin
    mov rdi, r14
    mov rsi, text_trailing_zeros
    mov rdx, 14
    call token_text_eq
    test rax, rax
    jnz .trailing_zeros_builtin
    mov rdi, r14
    mov rsi, text_gcd
    mov rdx, 3
    call token_text_eq
    ...
    call token_text_eq
    test rax, rax
    jnz .wrapping_add_builtin
    mov rdi, r14
    mov rsi, text_wrapping_sub
    mov rdx, 12
    call token_text_eq
    test rax, rax
    jnz .wrapping_sub_builtin
    mov rdi, r14
    mov rsi, text_wrapping_mul
    mov rdx, 12
    call token_text_eq
    test rax, rax
    jnz .wrapping_mul_builtin
    mov rdi, r14
    mov rsi, text_wrapping_pow
    mov rdx, 12
    call token_text_eq
    test rax, rax
    jnz .wrapping_pow_builtin
    mov rdi, r14
    mov rsi, text_wrapping_div
    mov rdx, 12
    call token_text_eq
    test rax, rax
    jnz .wrapping_div_builtin
    mov rdi, r14
    mov rsi, text_wrapping_mod
    mov rdx, 12
    call token_text_eq
    test rax, rax
    jnz .wrapping_mod_builtin
    mov rdi, r14
    mov rsi, text_saturating_add
    mov rdx, 14
    call token_text_eq
    test rax, rax
    jnz .saturating_add_builtin
    mov rdi, r14
    mov rsi, text_saturating_sub
    mov rdx, 14
    call token_text_eq
    test rax, rax
    jnz .saturating_sub_builtin
    mov rdi, r14
    mov rsi, text_saturating_mul
    mov rdx, 14
    call token_text_eq
    test rax, rax
    jnz .saturating_mul_builtin
    mov rdi, r14
    mov rsi, text_saturating_pow
    mov rdx, 14
    call token_text_eq
    test rax, rax
    jnz .saturating_pow_builtin
    mov rdi, r14
    mov rsi, text_saturating_div
    mov rdx, 14
    call token_text_eq
    test rax, rax
    jnz .saturating_div_builtin
    mov rdi, r14
...
.min_builtin:
    ...
    jmp .min_emit
.min_unsigned:
    mov rsi, asm_umin_rax
    mov rdx, asm_umin_rax_len
.min_emit:
    mov rdi, r12
...
.max_builtin:
    ...
    jmp .max_emit
.max_unsigned:
    mov rsi, asm_umax_rax
    mov rdx, asm_umax_rax_len
.max_emit:
    mov rdi, r12
    call emit_two_arg_math_builtin
    test rax, rax
...
.clamp_builtin:
    ...
    jmp .ok_handled
.sqrt_builtin:
    mov rsi, asm_call_sqrt_u64
    mov rdx, asm_call_sqrt_u64_len
    mov rdi, r12
    call emit_one_arg_math_builtin
    test rax, rax
    jnz .fail_handled
    mov byte [needs_sqrt_u64_helper], 1
    jmp .ok_handled
.cbrt_builtin:
    mov rsi, asm_call_cbrt_u64
    mov rdx, asm_call_cbrt_u64_len
    mov rdi, r12
    call emit_one_arg_math_builtin
    test rax, rax
    jnz .fail_handled
    mov byte [needs_cbrt_u64_helper], 1
    jmp .ok_handled
.popcount_builtin:
    mov rdi, r12
    call emit_bitcount_popcount_builtin
    test rax, rax
    jnz .fail_handled
    jmp .ok_handled
.leading_zeros_builtin:
    mov rdi, r12
    call emit_bitcount_leading_zeros_builtin
    test rax, rax
    jnz .fail_handled
    jmp .ok_handled
.trailing_zeros_builtin:
    mov rdi, r12
    call emit_bitcount_trailing_zeros_builtin
    test rax, rax
    jnz .fail_handled
    jmp .ok_handled
.gcd_builtin:
    mov rsi, asm_call_gcd_u64
    mov rdx, asm_call_gcd_u64_len
    mov rdi, r12
    call emit_two_arg_math_builtin
    test rax, rax
    jnz .fail_handled
    mov byte [needs_gcd_u64_helper], 1
    jmp .ok_handled
.lcm_builtin:
    mov rsi, asm_call_lcm_u64
    mov rdx, asm_call_lcm_u64_len
    mov rdi, r12
    call emit_two_arg_math_builtin
    test rax, rax
    jnz .fail_handled
    mov byte [needs_lcm_u64_helper], 1
    jmp .ok_handled
.wrapping_add_builtin:
    mov rsi, asm_add_rax
    mov rdx, asm_add_rax_len
    mov rdi, r12
    call emit_two_arg_wrapping_builtin
    test rax, rax
    jnz .fail_handled
    jmp .ok_handled
.wrapping_sub_builtin:
    mov rsi, asm_sub_rax
    mov rdx, asm_sub_rax_len
    mov rdi, r12
    call emit_two_arg_wrapping_builtin
...
.wrapping_mul_builtin:
    ...
    jnz .fail_handled
    jmp .ok_handled
.wrapping_pow_builtin:
    mov rdi, r12
    call emit_wrapping_pow_builtin
    test rax, rax
    jnz .fail_handled
    jmp .ok_handled
.wrapping_div_builtin:
    mov rdi, r12
    xor rsi, rsi
    call emit_wrapping_div_mod_builtin
    test rax, rax
    jnz .fail_handled
    jmp .ok_handled
.wrapping_mod_builtin:
    mov rdi, r12
    mov rsi, 1
    call emit_wrapping_div_mod_builtin
    test rax, rax
...
.saturating_add_builtin:
    ...
    jz .fail_handled
    mov rdi, rax
    call select_saturating_add_template_for_type
    test rax, rax
    jnz .fail_handled
    mov rdi, r12
    call emit_two_arg_math_builtin
    ...
    jnz .fail_handled
    jmp .ok_handled
.saturating_sub_builtin:
    mov rdi, r12
    call semantic_expr_type
    test rax, rax
    jz .fail_handled
    mov rdi, rax
    call select_saturating_sub_template_for_type
    test rax, rax
    jnz .fail_handled
    mov rdi, r12
    call emit_two_arg_math_builtin
    ...
    jnz .fail_handled
    jmp .ok_handled
.saturating_mul_builtin:
    mov rdi, r12
    call semantic_expr_type
    test rax, rax
    jz .fail_handled
    mov rdi, rax
    call select_saturating_mul_template_for_type
    test rax, rax
    jnz .fail_handled
    mov rdi, r12
    call emit_two_arg_math_builtin
    ...
    jnz .fail_handled
    jmp .ok_handled
.saturating_pow_builtin:
    mov rdi, r12
    call emit_saturating_pow_builtin
    test rax, rax
    jnz .fail_handled
    jmp .ok_handled
.saturating_div_builtin:
    mov rdi, r12
    xor rsi, rsi
...
emit_wrapping_div_mod_builtin:
    ...
    call write_all
    test r12, r12
    jnz .signed_mod_overflow
    mov rsi, asm_wrapping_div_overflow_value
    mov rdx, asm_wrapping_div_overflow_value_len
    jmp .write_signed_overflow_value
.signed_mod_overflow:
    mov rsi, asm_wrapping_mod_overflow_value
    mov rdx, asm_wrapping_mod_overflow_value_len
.write_signed_overflow_value:
    mov rdi, [out_fd]
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_jmp_pre
    ...
    call write_all
    test r12, r12
    jnz .signed_mod_normal
    mov rsi, asm_div_rax
    mov rdx, asm_div_rax_len
    jmp .write_signed_normal
.signed_mod_normal:
    mov rsi, asm_mod_rax
    mov rdx, asm_mod_rax_len
.write_signed_normal:
...
emit_saturating_div_mod_builtin:
    push rbx
    push r12
    push r13
    push r14
    ...
    call write_u64_fd
    mov rdi, r13
    call select_saturating_div_min_check_for_type
    test rax, rax
    jnz .fail
    mov rdi, [out_fd]
    call write_all
    ...
    jnz .signed_mod_overflow
    mov rdi, r13
    call select_saturating_div_overflow_value_for_type
    test rax, rax
    jnz .fail
    jmp .write_signed_overflow_value
.signed_mod_overflow:
    mov rsi, asm_saturating_mod_overflow_value
    mov rdx, asm_saturating_mod_overflow_value_len
.write_signed_overflow_value:
    mov rdi, [out_fd]
    call write_all
    mov rdi, [out_fd]
...
select_saturating_div_min_check_for_type:
    cmp rdi, TYPE_I8
    je .i8
    cmp rdi, TYPE_I16
    je .i16
    ...
    ret
.i8:
    mov rsi, asm_sdiv_overflow_check_i8_mid
    mov rdx, asm_sdiv_overflow_check_i8_mid_len
    xor rax, rax
    ret
.i16:
    mov rsi, asm_sdiv_overflow_check_i16_mid
    mov rdx, asm_sdiv_overflow_check_i16_mid_len
    xor rax, rax
    ret
.i32:
    mov rsi, asm_sdiv_overflow_check_i32_mid
    mov rdx, asm_sdiv_overflow_check_i32_mid_len
    xor rax, rax
    ret
.word:
    mov rsi, asm_sdiv_overflow_check_mid
...
select_saturating_div_overflow_value_for_type:
    cmp rdi, TYPE_I8
    je .i8
    cmp rdi, TYPE_I16
    je .i16
    ...
    ret
.i8:
    mov rsi, asm_saturating_div_overflow_i8_value
    mov rdx, asm_saturating_div_overflow_i8_value_len
    xor rax, rax
    ret
.i16:
    mov rsi, asm_saturating_div_overflow_i16_value
    mov rdx, asm_saturating_div_overflow_i16_value_len
    xor rax, rax
    ret
.i32:
    mov rsi, asm_saturating_div_overflow_i32_value
    mov rdx, asm_saturating_div_overflow_i32_value_len
    xor rax, rax
    ret
.word:
    mov rsi, asm_saturating_div_overflow_word_value
    mov rdx, asm_saturating_div_overflow_word_value_len
    xor rax, rax
    ret

select_saturating_add_template_for_type:
    cmp rdi, TYPE_I8
    je .si8
    cmp rdi, TYPE_I16
    je .si16
    ...
    ret
.si8:
    mov rsi, asm_ssaturating_add_i8_rax
    mov rdx, asm_ssaturating_add_i8_rax_len
    jmp .ok
.si16:
    mov rsi, asm_ssaturating_add_i16_rax
    mov rdx, asm_ssaturating_add_i16_rax_len
    jmp .ok
.si32:
    mov rsi, asm_ssaturating_add_i32_rax
    mov rdx, asm_ssaturating_add_i32_rax_len
    jmp .ok
.sword:
    mov rsi, asm_ssaturating_add_rax
    mov rdx, asm_ssaturating_add_rax_len
    jmp .ok
.u8:
    mov rsi, asm_usaturating_add_u8_rax
    mov rdx, asm_usaturating_add_u8_rax_len
    jmp .ok
.u16:
    mov rsi, asm_usaturating_add_u16_rax
    mov rdx, asm_usaturating_add_u16_rax_len
    jmp .ok
.u32:
    mov rsi, asm_usaturating_add_u32_rax
    mov rdx, asm_usaturating_add_u32_rax_len
    jmp .ok
.uword:
    mov rsi, asm_usaturating_add_rax
    mov rdx, asm_usaturating_add_rax_len
.ok:
    xor rax, rax
    ret

select_saturating_sub_template_for_type:
    cmp rdi, TYPE_I8
    je .si8
    cmp rdi, TYPE_I16
    je .si16
    ...
    ret
.si8:
    mov rsi, asm_ssaturating_sub_i8_rax
    mov rdx, asm_ssaturating_sub_i8_rax_len
    jmp .ok
.si16:
    mov rsi, asm_ssaturating_sub_i16_rax
    mov rdx, asm_ssaturating_sub_i16_rax_len
    jmp .ok
.si32:
    mov rsi, asm_ssaturating_sub_i32_rax
    mov rdx, asm_ssaturating_sub_i32_rax_len
    jmp .ok
.sword:
    mov rsi, asm_ssaturating_sub_rax
    mov rdx, asm_ssaturating_sub_rax_len
    jmp .ok
.u:
    mov rsi, asm_usaturating_sub_rax
    mov rdx, asm_usaturating_sub_rax_len
.ok:
    xor rax, rax
    ret

select_saturating_mul_template_for_type:
    cmp rdi, TYPE_I8
    je .si8
    cmp rdi, TYPE_I16
    je .si16
    ...
    ret
.si8:
    mov rsi, asm_ssaturating_mul_i8_rax
    mov rdx, asm_ssaturating_mul_i8_rax_len
    jmp .ok
.si16:
    mov rsi, asm_ssaturating_mul_i16_rax
    mov rdx, asm_ssaturating_mul_i16_rax_len
    jmp .ok
.si32:
    mov rsi, asm_ssaturating_mul_i32_rax
    mov rdx, asm_ssaturating_mul_i32_rax_len
    jmp .ok
.sword:
    mov rsi, asm_ssaturating_mul_rax
    mov rdx, asm_ssaturating_mul_rax_len
    jmp .ok
.u8:
    mov rsi, asm_usaturating_mul_u8_rax
    mov rdx, asm_usaturating_mul_u8_rax_len
    jmp .ok
.u16:
    mov rsi, asm_usaturating_mul_u16_rax
    mov rdx, asm_usaturating_mul_u16_rax_len
    jmp .ok
.u32:
    mov rsi, asm_usaturating_mul_u32_rax
    mov rdx, asm_usaturating_mul_u32_rax_len
    jmp .ok
.uword:
    mov rsi, asm_usaturating_mul_rax
    mov rdx, asm_usaturating_mul_rax_len
.ok:
    xor rax, rax
    ret

emit_saturating_pow_builtin:
    push rbx
    push r12
    push r13
    push r14
    ...
    test rax, rax
    jnz .unsigned_init
    mov rsi, asm_saturating_pow_signed_init_pre
    mov rdx, asm_saturating_pow_signed_init_pre_len
    jmp .write_init
.unsigned_init:
    mov rsi, asm_saturating_pow_unsigned_init_pre
    mov rdx, asm_saturating_pow_unsigned_init_pre_len
.write_init:
    mov rdi, [out_fd]
    call write_all
    mov rax, r15
    ...
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_saturating_pow_push_base
    mov rdx, asm_saturating_pow_push_base_len
    call write_all
    mov rdi, r13
    call select_saturating_mul_template_for_type
    test rax, rax
    ...
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_saturating_pow_loop_mid
    mov rdx, asm_saturating_pow_loop_mid_len
    call write_all
    mov rax, r14
    mov rdi, [out_fd]
    call write_u64_fd
...
emit_abs_builtin:
    ...
    jnz .ok
    mov rdi, r13
    call emit_signed_abs_overflow_check_for_type
    test rax, rax
    jnz .fail
    mov rdi, [out_fd]
    mov rsi, asm_abs_rax
...
emit_signed_abs_overflow_check_for_type:
    push rbx
    push r12
    mov r12, rdi
    mov rbx, [label_counter]
    ...
    cmp r12, TYPE_I32
    je .i32
    mov rsi, asm_sabs_overflow_i64_check_pre
    mov rdx, asm_sabs_overflow_i64_check_pre_len
    jmp .write_check
.i8:
    mov rsi, asm_sabs_overflow_i8_check_pre
    mov rdx, asm_sabs_overflow_i8_check_pre_len
    jmp .write_check
.i16:
    mov rsi, asm_sabs_overflow_i16_check_pre
    mov rdx, asm_sabs_overflow_i16_check_pre_len
    jmp .write_check
.i32:
    mov rsi, asm_sabs_overflow_i32_check_pre
    mov rdx, asm_sabs_overflow_i32_check_pre_len
.write_check:
    mov rdi, [out_fd]
    call write_all
    mov rax, rbx
    ...
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_sabs_overflow_trap
    mov rdx, asm_sabs_overflow_trap_len
    call write_all
    mov rdi, [out_fd]
    mov rsi, asm_label_pre
    mov rdx, asm_label_pre_len
...
emit_bitcount_popcount_builtin:
    push rbx
    push r12
    push r13
    mov r12, rdi
    ...
    jnz .fail
    mov rdi, r13
    call emit_bitcount_mask_for_type
    mov rdi, [out_fd]
    mov rsi, asm_popcount_rax
    mov rdx, asm_popcount_rax_len
    call write_all
    xor rax, rax
    pop r13
    pop r12
...
emit_bitcount_leading_zeros_builtin:
    push rbx
    push r12
    push r13
    mov r12, rdi
    ...
    call emit_bitcount_mask_for_type
    mov rdi, r13
    call emit_leading_zeros_for_type
    xor rax, rax
    pop r13
    pop r12
    pop rbx
...
emit_bitcount_trailing_zeros_builtin:
    push rbx
    push r12
    push r13
    mov r12, rdi
    ...
    call emit_bitcount_mask_for_type
    mov rdi, r13
    call emit_trailing_zeros_for_type
    xor rax, rax
    pop r13
    pop r12
    pop rbx
...
emit_bitcount_mask_for_type:
    ...
    ret
.mask8:
    mov rsi, asm_bitcount_mask8
    mov rdx, asm_bitcount_mask8_len
    jmp .write
.mask16:
    mov rsi, asm_bitcount_mask16
    mov rdx, asm_bitcount_mask16_len
    jmp .write
.mask32:
    mov rsi, asm_bitcount_mask32
    mov rdx, asm_bitcount_mask32_len
.write:
    mov rdi, [out_fd]
    call write_all
    xor rax, rax
...
emit_leading_zeros_for_type:
    ...
    cmp rdi, TYPE_U32
    je .w32
    mov rsi, asm_leading_zeros_rax
    mov rdx, asm_leading_zeros_rax_len
    jmp .write
.w8:
    mov rsi, asm_leading_zeros_8_rax
    mov rdx, asm_leading_zeros_8_rax_len
    jmp .write
.w16:
    mov rsi, asm_leading_zeros_16_rax
    mov rdx, asm_leading_zeros_16_rax_len
    jmp .write
.w32:
    mov rsi, asm_leading_zeros_32_rax
    mov rdx, asm_leading_zeros_32_rax_len
.write:
    mov rdi, [out_fd]
    call write_all
    xor rax, rax
...
emit_trailing_zeros_for_type:
    ...
    cmp rdi, TYPE_U32
    je .w32
    mov rsi, asm_trailing_zeros_rax
    mov rdx, asm_trailing_zeros_rax_len
    jmp .write
.w8:
    mov rsi, asm_trailing_zeros_8_rax
    mov rdx, asm_trailing_zeros_8_rax_len
    jmp .write
.w16:
    mov rsi, asm_trailing_zeros_16_rax
    mov rdx, asm_trailing_zeros_16_rax_len
    jmp .write
.w32:
    mov rsi, asm_trailing_zeros_32_rax
    mov rdx, asm_trailing_zeros_32_rax_len
.write:
    mov rdi, [out_fd]
    call write_all
    xor rax, rax
